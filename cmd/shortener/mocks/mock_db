...
func (m *MockDataBaseInterface) GetUserURLs(userID int) ([]storage.URLData, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDataBaseInterfaceMockRecorder) GetUserURLs(userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserURLs", reflect.TypeOf((*MockDataBaseInterface)(nil).GetUserURLs), userID)
}
